...
public class ViewsHolder {
     ...
     * 为ImageView设置图片
     */
    public ViewsHolder setImageForUrl(Context context, int viewId, String imgPath) {
        Glide.with(context).load(imgPath).thumbnail(0.2f).into((ImageView) getView(viewId));
        return this;
    }
